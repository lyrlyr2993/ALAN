...
def main():
    ...
    LULog.STARTLogging(
        LULog.TTypeSETUPLOG.tslINI,
        "console",
        LUConst.GDirectoryLOG,
        LUConst.GFileNameLOG,
    ...
    LArg = LArgParser.ArgParser.add_argument(
        "A1", type=str, default="A1_Default", help="A1"
    )
    LArg = LArgParser.ArgParser.add_argument(
        "-O1", "--O1", type=str, default="O1_Default", help="O1"
    )
